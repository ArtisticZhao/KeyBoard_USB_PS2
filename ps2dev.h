...
class PS2dev
{
    ...
    void keyboard_press_makesure(unsigned char code);
		void keyboard_release_makesure(unsigned char code);
		void keyboard_press_special_makesure(unsigned char code);
		void keyboard_release_special_makesure(unsigned char code);
